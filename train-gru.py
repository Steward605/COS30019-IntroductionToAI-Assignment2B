...
# Route terminal output to a GRU-specific log file
sys.stdout = Logger("logs/gru_full_terminal_output.txt")

# LOAD THE PROCESSED DATA
# ===================================
print("Loading data for GRU Model...")
...
model.save('models/gru_traffic_model.keras')
print("Model saved to 'models/gru_traffic_model.keras'")
...
plt.plot(real_predictions[:150], label='Predicted Traffic (GRU)', color='green', alpha=0.8, linestyle='--')
plt.title('Traffic Flow: Actual vs. GRU Predicted')
plt.xlabel('Hours')
plt.ylabel('Number of Vehicles')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('logs/gru_evaluation_plots.png')
print("Evaluation plots saved as 'logs/gru_evaluation_plots.png'!")
plt.show()
...
summary_text = f"""======================================================================
TRAINING SUMMARY - LEARNING CURVES (GRU REGRESSION)
======================================================================
...
======================================================================
"""
with open("logs/gru_training_summary.txt", "w") as f:
    f.write(summary_text)
print("Summary saved to 'logs/gru_training_summary.txt'!")